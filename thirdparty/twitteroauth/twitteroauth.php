...
class TwitterOAuth {
	...
	/**
	 * Set API URLS
	 * For the love of god, these are static!
	 */
	 ...
	 *                "screen_name" => "abraham")
	 */
	private function getAccessToken($oauth_verifier = FALSE) {
		$parameters = array();
	 ...
	 *                "x_auth_expires" => "0")
	 */  
	private function getXAuthToken($username, $password) {
		$parameters = array();
